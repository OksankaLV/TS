...
// hard way is ?...
function heyOne(a:{name:()=>string, cuteness?:number, coolness?: number}){
...
interface isBigObject { [key: string]: { cvalue?: string | number | isBigObject | undefined } | undefined }
    ...
    const x = Object.keys(a).map((k) => {
        ...
        if (/*typeof*/ elem === undefined) {
            ...
            if (elem.cvalue !== undefined) {
                ...
                if (typeof elem.cvalue === 'string') return +elem.cvalue || /*'2021'*/2021;
